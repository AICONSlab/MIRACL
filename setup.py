...
setup(
    ...
    install_requires=[
        'pandas==0.24.2', 'scipy==1.2.1', 'opencv-python', 'tifffile', 'nibabel==2.5.0', 'argparse', 'tables==3.5.2', 'allensdk',
        'lightning-python', 'multiprocessing', 'joblib', 'matplotlib==2.1.2', 'argcomplete', 'dipy==0.16.0', 'seaborn', 'pytest==4.6.0'
    ],
