...
RIGIDCONVERGENCE="[1000x500x250x100,1e-10,10]"
RIGIDSHRINKFACTORS="4x2x1x1"
RIGIDSMOOTHINGSIGMAS="3x2x1x0vox"

AFFINECONVERGENCE="[1000x500x250x100,1e-10,10]"
AFFINESHRINKFACTORS="4x2x1x1"
AFFINESMOOTHINGSIGMAS="3x2x1x0vox"

SYNCONVERGENCE="[400x200x100x80,1e-10,10]"
...
if [[ $TRANSFORMTYPE == 's' ]];
  then
    SYNSTAGE="--traantnsform SyN[0.1,3,0] \
             $SYNSTAGE"
  fi
