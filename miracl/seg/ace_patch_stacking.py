...
def run_stacking(patches_path, main_input_folder_path, output_folder_path, x, y, z, monte_carlo):
...
#                     input_path,
#                     image_mode + "patch" + "_" + str(d) + "_" + str(cnt_img) + ".tiff",
#                 )
#
#                 cnt_img += 1
#
