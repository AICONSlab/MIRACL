...
from miracl.system.registry.registry_refactor.gui.gui_pyqt_serializer import (
    PyQtGuiSerializer,
)
from miracl.system.registry.registry_refactor.gui.gui_pyqt_builder import (
    PyQtGuiBuilder,
)

# Load modules into registry from config YAML
registry = load_registry_from_yaml(
    "/code/miracl/system/registry/configs/modules_resolver_test_gui.yaml"
)
...
gui_serializer = PyQtGuiSerializer()
serialized_gui_objs = gui_serializer.serialize(module_objects)
gui_builder
