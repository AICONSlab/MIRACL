...
class SegAceObjs:
    ...
    resolution = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sar", "cli_l_flag": "sa_resolution"}},
    ...
    gpu_index = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sag", "cli_l_flag": "sa_gpu_index"}},
    ...
    image_size = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sas", "cli_l_flag": "sa_image_size"}},
        tags=["ace", "seg", "ace_flow"],
        cli_obj_type=ArgumentType.STRING,
    ...
    nr_workers = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "saw", "cli_l_flag": "sa_nr_workers"}},
        tags=["ace", "seg", "ace_flow"],
        cli_obj_type=ArgumentType.INTEGER,
        cli_required=False,
    ...
    cache_rate = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sac", "cli_l_flag": "sa_cache_rate"}},
        tags=["ace", "seg", "ace_flow"],
        cli_obj_type=ArgumentType.FLOAT,
        cli_required=False,
    ...
    batch_size = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sab", "cli_l_flag": "sa_batch_size"}},
        tags=["ace", "seg", "ace_flow"],
        cli_obj_type=ArgumentType.INTEGER,
        cli_required=False,
    ...
    monte_carlo = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "samc", "cli_l_flag": "sa_monte_carlo"}},
        tags=["ace", "seg", "ace_flow"],
        cli_obj_type=ArgumentType.INTEGER,
        obj_default=0,
    ...
    visualize_results = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sav", "cli_l_flag": "sa_visualize_results"}},
    ...
    uncertainty_map = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sau", "cli_l_flag": "sa_uncertainty_map"}},
    ...
    binarization_threshold = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "sat", "cli_l_flag": "sa_binarization_threshold"}},
        cli_obj_type=ArgumentType.FLOAT,
        cli_required=False,
        obj_default=0.5,
    ...
    percentage_brain_patch_skip = MiraclObj(
        ...
        flow={
            "ace": {"cli_s_flag": "sap", "cli_l_flag": "sa_percentage_brain_patch_skip"}
        },
        cli_required=False,
        cli_obj_type=ArgumentType.FLOAT,
        obj_default=0.0,
...
class SegVoxObjs:
    downsample = MiraclObj(
        ...
        cli_s_flag="d",
        cli_l_flag="downsample",
        flow={"ace": {"cli_s_flag": "rvad", "cli_l_flag": "rva_downsample"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    xy_res = MiraclObj(
        ...
        cli_s_flag="vx",
        cli_l_flag="vx_res",
        flow={"ace": {"cli_s_flag": "rvavx", "cli_l_flag": "rva_vx_res"}},
        cli_obj_type=ArgumentType.FLOAT,
    ...
    z_res = MiraclObj(
        ...
        cli_s_flag="vz",
        cli_l_flag="vz_res",
        flow={"ace": {"cli_s_flag": "rvavz", "cli_l_flag": "rva_vz_res"}},
        cli_obj_type=ArgumentType.FLOAT,
