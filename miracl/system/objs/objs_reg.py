...
class RegClarAllenObjs:
    orient_code = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "rcao", "cli_l_flag": "rca_orient_code"}},
    ...
    hemi = MiraclObj(
        ...
        cli_s_flag="m",
        cli_l_flag="hemi",
        flow={"ace": {"cli_s_flag": "rcam", "cli_l_flag": "rca_hemi"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    allen_label = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "rcal", "cli_l_flag": "rca_allen_label"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    allen_atlas = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "rcaa", "cli_l_flag": "rca_allen_atlas"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    side = MiraclObj(
        ...
        cli_s_flag="s",
        cli_l_flag="side",
        flow={"ace": {"cli_s_flag": "rcas", "cli_l_flag": "rca_side"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    no_mosaic_fig = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "rcanm", "cli_l_flag": "rca_no_mosaic_fig"}},
    ...
    olfactory_bulb = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "rcab", "cli_l_flag": "rca_olfactory_bulb"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    skip_cor = MiraclObj(
        ...
        cli_s_flag="p",
        cli_l_flag="skip_cor",
        flow={"ace": {"cli_s_flag": "rcap", "cli_l_flag": "rca_skip_cor"}},
    ...
    warp = MiraclObj(
        ...
        cli_s_flag="w",
        cli_l_flag="warp",
        flow={"ace": {"cli_s_flag": "rcaw", "cli_l_flag": "rca_warp"}},
...
class RegWarpClarObjs:
    voxel_size = MiraclObj(
        ...
        cli_s_flag="v",
        cli_l_flag="voxel_size",
        flow={"ace": {"cli_s_flag": "rwcv", "cli_l_flag": "rwc_voxel_size"}},
        obj_default=25,
        cli_choices=[10, 25, 50],
        cli_obj_type=ArgumentType.INTEGER,
    ...
    input_folder = MiraclObj(
        ...
        tags=["warp_clar", "reg", "ace_flow"],
        cli_s_flag="r",
        cli_l_flag="input_folder",
        flow={"ace": {"cli_s_flag": "rwcr", "cli_l_flag": "rwc_input_folder"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    input_nii = MiraclObj(
        ...
        tags=["warp_clar", "reg", "ace_flow"],
        cli_s_flag="i",
        cli_l_flag="input_nii",
        flow={"ace": {"cli_s_flag": "rwcn", "cli_l_flag": "rwc_input_nii"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    seg_channel = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "rwcc", "cli_l_flag": "rwc_seg_channel"}},
        cli_obj_type=ArgumentType.STRING,
