...
class StatsAceObjs:
    atlas_dir = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "ua", "cli_l_flag": "u_atlas_dir"}},
    ...
    p_outfile = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "po", "cli_l_flag": "p_outfile"}},
        cli_help="path of atlas directory (default: %(default)s)",
        gui_group={"ace_flow": "corr_stats"},
        version_added="2.4.0",
...
class StatsAceClustObjs:
    atlas_dir = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsa", "cli_l_flag": "pcs_atlas_dir"}},
    ...
    num_perm = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsn", "cli_l_flag": "pcs_num_perm"}},
    ...
    img_resolution = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsr", "cli_l_flag": "pcs_img_resolution"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    smoothing_fwhm = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsfwhm", "cli_l_flag": "pcs_smoothing_fwhm"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    tfce_start = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsstart", "cli_l_flag": "pcs_tfce_start"}},
    ...
    tfce_step = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsstep", "cli_l_flag": "pcs_tfce_step"}},
        cli_obj_type=ArgumentType.FLOAT,
    ...
    cpu_load = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsc", "cli_l_flag": "pcs_cpu_load"}},
        cli_obj_type=ArgumentType.FLOAT,
    ...
    tfce_h = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsh", "cli_l_flag": "pcs_tfce_h"}},
        cli_obj_type=ArgumentType.FLOAT,
    ...
    tfce_e = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcse", "cli_l_flag": "pcs_tfce_e"}},
        cli_obj_type=ArgumentType.FLOAT,
    ...
    step_down_p = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcssp", "cli_l_flag": "pcs_step_down_p"}},
        cli_obj_type=ArgumentType.FLOAT,
    ...
    mask_thr = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "pcsm", "cli_l_flag": "pcs_mask_thr"}},
        cli_obj_type=ArgumentType.INTEGER,
...
class StatsAceCorrObjs:
    pvalue_thr = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "cft", "cli_l_flag": "cf_pvalue_thr"}},
        cli_obj_type=ArgumentType.FLOAT,
...
class StatsHeatmapObjs:
    group1 = MiraclObj(
        ...
        cli_s_flag="g1",
        cli_l_flag="group1",
        flow={"ace": {"cli_s_flag": "shg1", "cli_l_flag": "sh_group1"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    group2 = MiraclObj(
        ...
        cli_s_flag="g2",
        cli_l_flag="group2",
        flow={"ace": {"cli_s_flag": "shg2", "cli_l_flag": "sh_group2"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    vox = MiraclObj(
        ...
        cli_s_flag="v",
        cli_l_flag="vox",
        flow={"ace": {"cli_s_flag": "shv", "cli_l_flag": "sh_vox"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    sigma = MiraclObj(
        ...
        cli_s_flag="gs",
        cli_l_flag="sigma",
        flow={"ace": {"cli_s_flag": "shgs", "cli_l_flag": "sh_sigma"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    percentile = MiraclObj(
        ...
        module_group="stats",
        cli_s_flag="p",
        cli_l_flag="percentile",
        flow={"ace": {"cli_s_flag": "shp", "cli_l_flag": "sh_percentile"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    colourmap_pos = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "shcp", "cli_l_flag": "sh_colourmap_pos"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    colourmap_neg = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "shcn", "cli_l_flag": "sh_colourmap_neg"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    sagittal = MiraclObj(
        ...
        cli_s_flag="s",
        cli_l_flag="sagittal",
        flow={"ace": {"cli_s_flag": "shs", "cli_l_flag": "sh_sagittal"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    coronal = MiraclObj(
        ...
        cli_s_flag="c",
        cli_l_flag="coronal",
        flow={"ace": {"cli_s_flag": "shc", "cli_l_flag": "sh_coronal"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    axial = MiraclObj(
        ...
        cli_s_flag="a",
        cli_l_flag="axial",
        flow={"ace": {"cli_s_flag": "sha", "cli_l_flag": "sh_axial"}},
        cli_obj_type=ArgumentType.INTEGER,
    ...
    figure_dim = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "shf", "cli_l_flag": "sh_figure_dim"}},
        cli_obj_type=ArgumentType.FLOAT,
    ...
    outfolder = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "shd", "cli_l_flag": "sh_dir_outfile"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    outfile = MiraclObj(
        ...
        cli_s_flag="o",
        cli_l_flag="outfile",
        flow={"ace": {"cli_s_flag": "sho", "cli_l_flag": "sh_outfile"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    extension = MiraclObj(
        ...
        flow={"ace": {"cli_s_flag": "she", "cli_l_flag": "sh_extension"}},
        cli_obj_type=ArgumentType.STRING,
    ...
    dpi = MiraclObj(
        ...
        module_group="stats",
        cli_l_flag="dpi",
        flow={"ace": {"cli_s_flag": "shdpi", "cli_l_flag": "sh_dpi"}},
        cli_obj_type=ArgumentType.INTEGER,
