...
if __name__ == "__main__":
    runtime = MiraclRuntime(
        registry_config="/code/miracl/system/pipelines/configs/registries/conv_reg_workflow_modules_config.yaml",
        workflow_config="/code/miracl/system/pipelines/configs/workflows/conv_reg_workflow_config.yaml",
    )
