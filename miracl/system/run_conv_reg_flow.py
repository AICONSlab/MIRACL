...
from miracl.system.gui.gui_hybrid_builder import MiraclGradioBuilder
...
gui_serializer = MiraclGUISerializer()
schema = gui_serializer.serialize(
    resolved_objects=module_objects,
    meta=meta_block,
)

builder = MiraclGradioBuilder()
result = builder.build_form(schema)
